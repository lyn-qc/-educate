...
import { VideoCameraOutlined, StockOutlined, AuditOutlined, StarOutlined, ProfileOutlined, EyeOutlined, PayCircleOutlined, UserAddOutlined,LikeOutlined  } from '@ant-design/icons'
          ...
          <div className='flex'>
            <div>
              ...
              <div className='ml-[6rem] mt-[2rem]'>
                <div className='mb-[2rem]'>课程评论</div>
                <div>
                  <table>
                          ...
                          <tr key={index}>
                            <td className='w-[20rem]'>
                              <div className='flex mt-[1rem]'>
                                ...
                                <div className='ml-[1rem] w-[13rem]'>{item.title}</div>
                              </div>
                            </td>
                            <td className='w-[7rem] mt-[3rem]'>
                              <div >
                                <div>{item.name}</div>
                                <div>{item.addres}</div>
                              </div>
                            ...
                            <td>
                              <div className='mt-[3rem] '><Rate allowHalf defaultValue={item.ev}
                                className='text-[3rem]  relative bottom-6' style={{ color: '#FDCB9E' }} /></div>
                              <div>{item.text}</div>
                            </td>
            ...
            <div className='w-[20rem] h-[10rem] bg-[#F7F7F7]  rounded-[1rem] mt-[2rem] ml-[4rem]'>
              ...
              <div>
                <div className='mt-[3rem]'>平均评分</div>
                <div className='flex mt-[2rem]'>
                  <Rate allowHalf defaultValue={4.5} style={{ color: '#FDCB9E', marginRight: '1rem' }} />
                  <div>4.5/5</div>
                  <div className='text-[#A5CC8F] ml-[1rem]'>
                    <StockOutlined />
                  </div>
              ...
              <div>
                <>
                  <div className='mt-[1rem]'><span className='mr-[1rem]  text-[#FDCB9E]'><StarOutlined style={{backgroundColor: '#FDCB9E'}} /></span><span className='mr-[1rem]'>5星</span><Progress percent={100} strokeColor="#FDCB9E" strokeWidth={10} showInfo={false} style={{ width: "15rem" }} /></div>
                  <div className='mt-[1rem]'><span className='mr-[1rem] text-[#FDCB9E]'><StarOutlined   style={{backgroundColor: '#FDCB9E'}}/></span><span className='mr-[1rem]'>4星</span><Progress percent={80} strokeColor="#FDCB9E" strokeWidth={10} showInfo={false} style={{ width: "15rem" }} /></div>
                  <div className='mt-[1rem]'> <span className='mr-[1rem]  text-[#FDCB9E]'> <StarOutlined   style={{backgroundColor: '#FDCB9E'}}/></span><span className='mr-[1rem]'>3星</span><Progress percent={60} strokeColor="#FDCB9E" strokeWidth={10} showInfo={false} style={{ width: "15rem" }} /></div>
                  <div className='mt-[1rem]'><span className='mr-[1rem] text-[#FDCB9E]'><StarOutlined  style={{backgroundColor: '#FDCB9E'}} /></span><span className='mr-[1rem]'>2星</span><Progress percent={40} strokeColor="#FDCB9E" strokeWidth={10} showInfo={false} style={{ width: "15rem" }} /></div>
                  <div className='mt-[1rem]'> <span className='mr-[1rem]  text-[#FDCB9E]'><StarOutlined  style={{backgroundColor: '#FDCB9E'}} /></span><span className='mr-[1rem]'>1星</span><Progress percent={20} strokeColor="#FDCB9E" strokeWidth={10} showInfo={false} style={{ width: "15rem" }} /></div>
                </>
              </div>
              <div>
                ...
                <div>
                  <div>
                    <div className='w-[5rem] h-[5rem] rounded-[5rem] bg-[#B5E49A]'><LikeOutlined /></div>
                  </div>
                  <div></div>
                </div>
              </div>
